...
public class RelatorioFormacaoPrincipal extends JFrame {
	...
	public static void carregaDados(DefaultTableModel model, String nome) {
		...
		List<Professor> list = pdao.listarFormaPrinc(nome);
	 ...
	 * @param palavra 
	 */
	public RelatorioFormacaoPrincipal(String palavra) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RelatorioFormacaoPrincipal.class.getResource("/Imagem/Senai.png")));
