...
public class AtualizaUsuario extends JDialog {
	...
	public AtualizaUsuario(DefaultTableModel model, int codigo) {
		setTitle("SENAI Teachers   |    Atualizar Usu\u00E1rio");
		String user = System.getProperty("user.name");
		getContentPane().add(new JLabel(new ImageIcon("C:\\Users\\"+user+"\\Documents\\SENAI Teachers\\src\\Fundo de tela-SENAI.png")));
		setIconImage(Toolkit.getDefaultToolkit().getImage(AtualizaUsuario.class.getResource("/Imagem/Senai.png")));
