...
public class TabelaObservacao extends JDialog {
	...
	public TabelaObservacao(int codigo1, String nome) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(TabelaObservacao.class.getResource("/Imagem/Senai.png")));
		...
		btnNovo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==btnNovo) {
					setVisible(false);
					CadastroObservações cp = new CadastroObservações( p.getCodigo(), u.getNome(), u.getCodigo());
					cp.setVisible(true);
					System.out.println(u.getNome());
				}
			}
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				setVisible(false);
				AtualizarObservacao ao = new AtualizarObservacao( codigo, p.getCodigo(), u.getNome(), u.getCodigo());
				ao.setVisible(true);
			}
		});
