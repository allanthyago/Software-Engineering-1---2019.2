...
public class JanelaAtuaçãoSec extends JFrame {
	 ...
	 * Create the frame.
	 */
	public JanelaAtuaçãoSec() {
		setTitle("SENAI Teachers   |   Atua\u00E7\u00E3o Secund\u00E1ria");
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(JanelaAtuaçãoSec.class.getResource("/Imagem/Senai.png")));
						...
						EventQueue.invokeLater(new Runnable() {
							public void run() {
								try {
									...
									RelatorioAtuacaoSec rfp = new RelatorioAtuacaoSec(p.getPalavra());
									rfp.setVisible(true);
									dispose();
								} catch (Exception e) {
									e.printStackTrace();
