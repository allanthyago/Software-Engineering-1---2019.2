...
public class AtualizarObservacaoEdProf extends JDialog {
	 ...
	 * Create the frame.
	 */
	public AtualizarObservacaoEdProf(int codigo, int prof, String string, int usuario) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(AtualizarObservacaoEdProf.class.getResource("/Imagem/Senai.png")));
			...
			public void windowClosing(WindowEvent e) {
				int reply = JOptionPane.showConfirmDialog(null, "Deseja cancelar?", "Confirma Exit", JOptionPane.YES_NO_OPTION);
				  if (reply == JOptionPane.YES_OPTION)
				  {
				    ...
				    TabelaObsEdirProf novaJanela = new TabelaObsEdirProf(p.getCodigo(), u.getNome());
					dispose();
