...
public class RelatorioFormacaoSecundaria extends JFrame {
	...
	public static void carregaDados(DefaultTableModel model, String nome) {
		...
		List<Professor> list = pdao.listarFormaSec(nome);
	 ...
	 * @param palavra 
	 */
	public RelatorioFormacaoSecundaria(String palavra) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RelatorioFormacaoSecundaria.class.getResource("/Imagem/Senai.png")));
