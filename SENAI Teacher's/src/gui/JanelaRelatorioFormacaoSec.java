...
public class JanelaRelatorioFormacaoSec extends JFrame {
	...
	public JanelaRelatorioFormacaoSec() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(JanelaRelatorioFormacaoSec.class.getResource("/Imagem/Senai.png")));
		...
		btnPesquisar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JasperPrint print = JasperFillManager.fillReport("C:\\Users\\"+user+"\\Documents\\SENAI Teachers\\MyReports\\relatorios\\Relatorio.jasper",null,conexao);
