...
public class AtualizarObservacao extends JDialog {
	 ...
	 * Create the frame.
	 */
	public AtualizarObservacao(int codigo, int prof, String string, int usuario) {
		o=odao.getObservacao(codigo);
		p=pdao.getProfessor(prof);
		u=udao.getUsuario(usuario);
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(AtualizarObservacao.class.getResource("/Imagem/Senai.png")));
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				int reply = JOptionPane.showConfirmDialog(null, "Deseja cancelar?", "Confirm Exit", JOptionPane.YES_NO_OPTION);
				  if (reply == JOptionPane.YES_OPTION)
				  {
				    System.out.println("Confirmou");
				    TabelaObservacao novaJanela = new TabelaObservacao(p.getCodigo(), u.getNome());
					dispose();
