...
public class RelatorioAtuacaoPrincipal extends JFrame {

	private DefaultTableModel modelTD = new DefaultTableModel();
	private JPanel contentPane;
	private JTable table;
	JanelaAtuaçãoPrinc jfp = new JanelaAtuaçãoPrinc();	
	
	public static void carregaDados(DefaultTableModel model, String nome) {
		model.setNumRows(0);
		ProfessorDAO pdao = new ProfessorDAO();
		List<Professor> list = pdao.listarAtuaPrinc(nome);
	 ...
	 * @param palavra 
	 */
	public RelatorioAtuacaoPrincipal(String palavra) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RelatorioAtuacaoPrincipal.class.getResource("/Imagem/Senai.png")));
