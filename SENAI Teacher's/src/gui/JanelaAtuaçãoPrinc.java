...
public class JanelaAtuaçãoPrinc extends JFrame {
	 ...
	 * Create the frame.
	 */
	public JanelaAtuaçãoPrinc() {
		setTitle("SENAI Teachers   |   Atua\u00E7\u00E3o Principal");
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(JanelaAtuaçãoPrinc.class.getResource("/Imagem/Senai.png")));
						...
						EventQueue.invokeLater(new Runnable() {
							public void run() {
								try {
									...
									RelatorioAtuacaoPrincipal rfp = new RelatorioAtuacaoPrincipal(p.getPalavra());
									rfp.setVisible(true);
									dispose();
								} catch (Exception e) {
									e.printStackTrace();
